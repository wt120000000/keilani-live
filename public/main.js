// Pin the SDK to a known-stable version (avoid 'latest' to prevent bundle quirks)
import * as sdk from "https://cdn.jsdelivr.net/npm/@d-id/client-sdk@0.7.3/dist/client-sdk.mjs";
...
// Run everything inside an async IIFE so top-level await works everywhere
(async () => {
  ...
  // 3) Force TURN relay to survive strict networks (works around ICE failures)
  ...
  // 6) Test Speak: bypass backend to verify stream+voice
